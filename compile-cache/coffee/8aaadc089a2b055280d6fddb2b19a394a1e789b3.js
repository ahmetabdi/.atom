(function() {
  var CompositeDisposable, HighlightedAreaView, Range, View, _, _ref,
  ...
  module.exports = HighlightedAreaView = (function(_super) {
    ...
    HighlightedAreaView.prototype.subscribeToActiveTextEditor = function() {
      ...
      this.selectionSubscription.add((_ref2 = this.getActiveEditor()) != null ? _ref2.onDidAddSelection((function(_this) {
        return function() {
          return _this.handleSelection();
        };
      })(this)) : void 0);
      this.selectionSubscription.add((_ref3 = this.getActiveEditor()) != null ? _ref3.onDidChangeSelectionRange((function(_this) {
        return function() {
          return _this.handleSelection();
        };
      })(this)) : void 0);
