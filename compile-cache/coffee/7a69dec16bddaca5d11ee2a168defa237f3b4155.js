(function() {
  ...
  describe("BeautifyLanguages", function() {
    ...
    allLanguages = ["c", "coffee-script", "css", "html", "java", "javascript", "json", "less", "mustache", "objective-c", "perl", "php", "python", "ruby", "sass", "sql", "typescript", "xml", "csharp", "gfm", "marko", "tss", "go", "html-swig"];
    beforeEach(function() {
