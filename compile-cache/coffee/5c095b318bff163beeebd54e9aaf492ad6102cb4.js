(function() {
  var Beautify, beautifier, defaultLanguageOptions, fs, languages, options, path;
  ...
  describe("BeautifyLanguages", function() {
    ...
    allLanguages = ["c", "coffee-script", "css", "html", "java", "javascript", "json", "less", "mustache", "objective-c", "perl", "php", "python", "ruby", "sass", "sql", "typescript", "xml", "csharp", "gfm", "marko", "tss"];
    beforeEach(function() {
                      ...
                      _results2.push((function(testFileName) {
                        ...
                        return it("" + testName + " " + testFileName, function() {
                          ...
                          runs(function() {
                            var e;
                            try {
                              return beautifier.beautify(originalContents, grammarName, allOptions, completionFun);
                            } catch (_error) {
                              e = _error;
