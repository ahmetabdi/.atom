(function() {
  "use strict";
  var $, Beautifiers, LoadingView, Promise, Subscriber, async, beautifier, beautify, beautifyDirectory, beautifyFile, beautifyFilePath, debug, defaultLanguageOptions, dir, fs, getCursors, handleSaveEvent, loadingView, logger, path, pkg, plugin, setCursors, showError, strip, yaml, _;
  ...
  debug = function() {
    var addHeader, addInfo, allOptions, codeBlockSyntax, debugInfo, editor, filePath, grammarName, text;
    editor = atom.workspace.getActiveTextEditor();
    if (editor == null) {
    ...
    return Promise.all(allOptions).then(function(allOptions) {
      var cb, configOptions, e, editorConfigOptions, editorOptions, homeOptions, logs, projectOptions, subscription;
      ...
      disposable = buffer.onDidSave(function(_arg) {
        ...
        if (beautifyOnSave) {
          ...
          return beautifyFilePath(filePath, function() {
            ...
            setCursors(editor, posArray);
            return editor.setScrollTop(origScrollTop);
          });
        }
      });
  ...
  plugin.activate = function() {
    ...
    return atom.commands.add(".tree-view .directory .name", "atom-beautify:beautify-directory", beautifyDirectory);
  };
