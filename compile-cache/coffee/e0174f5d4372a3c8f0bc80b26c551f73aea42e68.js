(function() {
  ...
  LinterRuby = (function(_super) {
    ...
    function LinterRuby(editor) {
      ...
      this.rubyLinter = atom.config.observe('linter-ruby.rubyExecutablePath', (function(_this) {
        return function() {
    ...
    LinterRuby.prototype.destroy = function() {
      LinterRuby.__super__.destroy.apply(this, arguments);
      return this.rubyLinter.dispose();
    };
