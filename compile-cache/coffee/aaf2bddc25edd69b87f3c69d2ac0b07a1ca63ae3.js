...
(function() {
  ...
  module.exports = Languages = (function() {
    Languages.prototype.languageNames = ["c-sharp", "c", "coffeescript", "cpp", "css", "csv", "d", "ejs", "erb", "go", "fortran", "handlebars", "html", "java", "javascript", "json", "jsx", "less", "markdown", 'marko', "mustache", "objective-c", "pawn", "perl", "php", "python", "ruby", "rust", "sass", "scss", "spacebars", "sql", "swig", "tss", "twig", "typescript", "vala", "visualforce", "xml"];
