...
(function() {
  ...
  module.exports = PerlTidy = (function(_super) {
    ...
    PerlTidy.prototype.beautify = function(text, language, options) {
      return this.run("perltidy", ['--standard-output', '--standard-error-output', '--quiet', options.perltidy_profile != null ? "--profile=" + options.perltidy_profile : void 0, this.tempFile("input", text)]);
    };
