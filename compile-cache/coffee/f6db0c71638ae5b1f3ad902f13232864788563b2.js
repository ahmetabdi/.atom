(function() {
  ...
  beautify = function(_arg) {
    ...
    showError = (function(_this) {
      return function(error) {
        ...
        if (!atom.config.get("atom-beautify.muteAllErrors")) {
          ...
          return (_ref = atom.notifications) != null ? _ref.addFatalError(error.message, {
            stack: stack,
            detail: detail,
            dismissable: true
          }) : void 0;
    ...
    try {
      beautifier.beautify(text, allOptions, grammarName, editedFilePath).then(beautifyCompleted)["catch"](beautifyCompleted);
    } catch (_error) {
      e = _error;
      showError(e);
    }
