(function() {
  var Minimap, MinimapElement, TextEditor, fs, mousedown, mousemove, mouseup, mousewheel, path, realOffsetLeft, realOffsetTop, sleep, stylesheet, stylesheetPath, _ref;
  ...
  _ref = require('./helpers/events'), mousemove = _ref.mousemove, mousedown = _ref.mousedown, mouseup = _ref.mouseup, mousewheel = _ref.mousewheel;
  ...
  describe('MinimapElement', function() {
    ...
    return describe('when attached to the text editor element', function() {
      var canvas, nextAnimationFrame, noAnimationFrame, visibleArea, _ref2;
      _ref2 = [], noAnimationFrame = _ref2[0], nextAnimationFrame = _ref2[1], canvas = _ref2[2], visibleArea = _ref2[3];
      beforeEach(function() {
      ...
      describe('when the update is performed', function() {
        ...
        describe('when the editor visible content is changed', function() {
          ...
          return it('rerenders the part that have changed', function() {
            ...
            return expect(minimapElement.drawLines.calls[1].args[2]).toEqual(101);
          });
        });
        return describe('when the editor visibility change', function() {
          return it('does not modify the size of the canvas', function() {
      ...
      describe('mouse scroll controls', function() {
        ...
        describe('pressing the mouse on the minimap canvas (without scroll animation)', function() {
          ...
          return it('scrolls the editor to the line below the mouse', function() {
            return expect(editor.getScrollTop()).toEqual(360);
          });
        });
      ...
      describe('when the atom themes are changed', function() {
        beforeEach(function() {
          nextAnimationFrame();
      ...
      describe('when minimap.displayMinimapOnLeft setting is true', function() {
        it('moves the attached minimap to the left', function() {
          ...
          return expect(Array.prototype.indexOf.call(editorElement.shadowRoot.children, minimapElement)).toEqual(0);
        });
      ...
      describe('when minimap.minimapScrollIndicator setting is true', function() {
        ...
        describe('on update', function() {
          beforeEach(function() {
            ...
            editorElement.style.height = '500px';
            waitsFor(function() {
              return editor.getHeight() !== height;
            });
            sleep(150);
            return runs(function() {
              return nextAnimationFrame();
      ...
      return describe('when minimap.displayPluginsControls setting is true', function() {
        ...
        return describe('with plugins registered in the package', function() {
          ...
          it('creates one list item for each registered plugin', function() {
            return expect(quickSettingsElement.querySelectorAll('li').length).toEqual(4);
          });
          ...
          describe('core:confirm', function() {
            ...
            return describe('on the code highlight item', function() {
              var initial;
              initial = [][0];
              beforeEach(function() {
