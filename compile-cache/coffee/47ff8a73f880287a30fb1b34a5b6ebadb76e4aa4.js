(function() {
  ...
  module.exports = AutocompleteManager = (function() {
    ...
    AutocompleteManager.prototype.bufferChanged = function(_arg) {
      var autoActivationEnabled, newText, oldText, wouldAutoActivate, _ref1, _ref2;
      ...
      wouldAutoActivate = (_ref1 = newText.trim().length, __indexOf.call([1, 2], _ref1) >= 0) || ((this.backspaceTriggersAutocomplete || this.suggestionList.isActive()) && (_ref2 = oldText.trim().length, __indexOf.call([1, 2], _ref2) >= 0));
