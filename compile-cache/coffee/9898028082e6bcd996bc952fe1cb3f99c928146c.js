(function() {
  ...
  module.exports = CanvasDrawer = (function(_super) {
    ...
    CanvasDrawer.prototype.drawLines = function(context, firstRow, lastRow, offsetRow) {
      var canvasWidth, charHeight, charWidth, color, decoration, decorations, displayCodeHighlights, highlightDecorations, line, lineDecorations, lineHeight, lines, re, row, screenRow, token, value, w, x, y, y0, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4;
      if (firstRow > lastRow) {
        return;
      }
      ...
      decorations = this.minimap.decorationsForScreenRowRangeByTypeThenRows(firstRow, lastRow);
      line = lines[0];
