(function() {
  ...
  MinimapElement = (function(_super) {
    ...
    MinimapElement.prototype.pollDOM = function() {
      if (this.isVisible()) {
        return this.measureHeightAndWidth(false);
      }
    };
    ...
    MinimapElement.prototype.measureHeightAndWidth = function(forceUpdate) {
      var canvasWidth, lineLength, softWrap, softWrapAtPreferredLineLength, visibilityChanged, wasResized, width;
      if (forceUpdate == null) {
        forceUpdate = true;
      }
