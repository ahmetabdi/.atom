    ...
    Beautifiers.prototype.beautify = function(text, allOptions, grammar, filePath, _arg) {
      ...
      return new Promise((function(_this) {
        return function(resolve, reject) {
          var analytics, beautifier, beautifiers, beautifyOnSave, detail, fallback, fileExtension, langDisabled, language, languages, legacyBeautifyOnSave, options, preferredBeautifierName, repoBugsUrl, title, transformOptions, unsupportedGrammar, userId, uuid, version, _i, _len, _ref;
          ...
          if (unsupportedGrammar) {
            if (atom.config.get("atom-beautify.muteUnsupportedLanguageErrors")) {
              ...
              detail = "Atom Beautify could not determine a supported beautifier to handle this file with grammar \"" + grammar + "\" and extension \"" + fileExtension + "\". If you would like to request support for this file and it's language, please create an issue for Atom Beautify at " + repoBugsUrl;
