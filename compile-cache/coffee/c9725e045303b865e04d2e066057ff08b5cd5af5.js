(function() {
  ...
  module.exports = Beautifiers = (function() {
     ...
     */
    Beautifiers.prototype.beautifierNames = ['uncrustify', 'autopep8', 'coffee-formatter', 'coffee-fmt', 'htmlbeautifier', 'csscomb', 'gofmt', 'fortran-beautifier', 'js-beautify', 'perltidy', 'php-cs-fixer', 'prettydiff', 'rubocop', 'ruby-beautify', 'sqlformat', 'tidy-markdown', 'typescript-formatter'];
        ...
        return function(allOptions) {
          return new Promise(function(resolve, reject) {
            ...
            if (languages.length < 1) {
              ...
              options = _this.getOptions([language.namespace].concat(language.fallback || []), allOptions) || {};
    ...
    Beautifiers.prototype.getOptionsForPath = function(editedFilePath, editor) {
      ...
      if (editedFilePath != null) {
        ...
        editorConfigOptions = editorconfig.parse(editedFilePath).then((function(_this) {
          return function(editorConfigOptions) {
