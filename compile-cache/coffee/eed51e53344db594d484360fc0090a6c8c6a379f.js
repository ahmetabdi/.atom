  ...
  describe('Suggestion List Element', function() {
    ...
    describe('getDisplayHTML', function() {
      ...
      it('replaces a snippet with escaped right braces', function() {
        ...
        replacementPrefix = 'a';
        return expect(suggestionListElement.getDisplayHTML(text, snippet, replacementPrefix)).toBe('<span class="character-match">a</span>bc(<span class="snippet-completion">d</span>, <span class="snippet-completion">e</span>)f <span class="snippet-completion">interface{}</span>');
      });
      it('replaces a snippet with escaped multiple right braces', function() {
        ...
        replacementPrefix = 'a';
        return expect(suggestionListElement.getDisplayHTML(text, snippet, replacementPrefix)).toBe('<span class="character-match">a</span>bc(<span class="snippet-completion">d</span>, <span class="snippet-completion">something{ok}</span>, <span class="snippet-completion">e</span>)f <span class="snippet-completion">interface{}</span>');
      });
      return it('replaces a snippet with elements that have no text', function() {
        ...
        replacementPrefix = 'a';
        return expect(suggestionListElement.getDisplayHTML(text, snippet, replacementPrefix)).toBe('<span class="character-match">a</span>bc(<span class="snippet-completion">d</span>, <span class="snippet-completion">e</span>)f');
      });
    });
