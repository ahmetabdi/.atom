(function() {
  ...
  SuggestionListElement = (function(_super) {
    ...
    SuggestionListElement.prototype.renderItems = function() {
      ...
      this.descriptionContainer.style['max-width'] = "" + this.offsetWidth + "px";
    ...
    SuggestionListElement.prototype.renderItem = function(_arg, index) {
      ...
      wordSpan.innerHTML = this.getDisplayHTML(text, snippet, replacementPrefix);
    ...
    SuggestionListElement.prototype.getDisplayHTML = function(text, snippet, replacementPrefix) {
