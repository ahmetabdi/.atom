  ...
  describe('Tabs to Spaces', function() {
    ...
    describe('activate', function() {
      return it('creates the commands', function() {
        ...
        return expect(helper.hasCommand(workspaceElement, 'tabs-to-spaces:untabify')).toBeTruthy();
      });
    });
    describe('deactivate', function() {
      ...
      return it('destroys the commands', function() {
        ...
        return expect(helper.hasCommand(workspaceElement, 'tabs-to-spaces:untabify')).toBeFalsy();
      });
    });
